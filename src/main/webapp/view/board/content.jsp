		...
		<table width="500" align="center">
			<tr>
				<td align="center"><input type="button" id="likebutton"
					value="1"> <!-- 벨류에 추천1 늘때마다 숫자 늘어나는 코드 넣어주기 --> <input
					type="button" class="contentbt" value="답글"> <input
					type="button" class="contentbt" value="수정"> <!-- 글쓴이만 이 버튼이 보이도록 코드 수정 -->
					<input type="button" class="contentbt" value="목록"></td>
			</tr>
		</table>
	</form>
