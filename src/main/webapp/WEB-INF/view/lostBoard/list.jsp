...
<body>
	...
	<div align="center">
	<table width="1000px">
      <tr><td colspan="5"><h3><b>분실물 서비스 게시판</b></h3></td></tr>
      ...
      <!-- <b>글목록(전체 글 : ${map.count } )</b> -->
		<table id="listtab" class="list">
			...
			<c:forEach var="vo" items="${map.list }" varStatus="status" >
				<tr height="30">
					...
					<td width="650"><a href="getLostBoard.do?seq=${vo.seq}&&id=${member.id}&&curPage=${map.pagination.curPage }&searchOption=${map.searchOption}&keyword=${map.keyword}">
		...
		<table width="1000">
			<tr>
				<td align="right">
					<form name="form" action="writeLostBoard.do" method="POST">
	...
	<form method="post" action="getLostBoardList.do">
			<table>
				<tr>
	...
	<script>
		function fn_paging(curPage) {
			location.href = "getLostBoardList.do?curPage=" + curPage
