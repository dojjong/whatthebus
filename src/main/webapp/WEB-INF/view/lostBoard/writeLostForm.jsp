...
<body>
	...
	<br />
	<form method="post" id="writeForm" name="writeForm" action="insertLostBoard.do">
		...
		<table border="1" align="center" id="outline" width="1000">
			...
			<tr>
				...
				<td width="700"><input type="text" size="110" maxlength="50" id="title" name="title" /></td>
			...
			<tr>
				...
				<input type="button" class="writebt" value="목록" onclick="location.href='getLostBoardList.do'"></td>
			</tr>
		</table>
	</form>
	<br/>
