...
<body>
	...
	<br />
	<form method="post" id="updateEventForm" name="updateEventForm"
		action="updateEventBoard.do?seq=${vo.seq}">
		...
		<table border="1" align="center">
			...
			<tr>
				<td colspan="2" align="center"><input type="submit"
					...
					href="getEventBoardList.do"> <input type="button" class="contentbt"
						value="목록"></a>
			</tr>
		</table>
	</form>
