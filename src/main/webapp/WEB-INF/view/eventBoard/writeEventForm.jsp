...
<body>
	...
	<br />
	<form method="post" id="writeForm" name="writeForm" action="insertEventBoard.do">
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<input type="button" class="writebt" value="목록" onclick="location.href='getEventBoardList.do'"></td>
			</tr>
		</table>
	</form>
