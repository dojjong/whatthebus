...
<body>
	<form action="updateEventForm.do?seq=${vo.seq}" method="post">
		...
		<table width="500" align="center">
			<tr>
				<td align="center"><c:choose>
					...
					</c:choose> <a href="getEventBoardList.do"> <input type="button"
	...
	<%@include file="../eventBoard/comment.jsp"%>
	
	<script>
		$("#deleteButton").click(function() {
			if (confirm("정말 삭제하시겠습니까 ? ")) {
				location.href = "deleteEventBoard.do?seq=${vo.seq }";
			}
		});
