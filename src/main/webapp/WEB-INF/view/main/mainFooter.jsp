			...
			<tr>
				...
				<td align="left"><br />주식회사 <strong>&nbsp;WhatTheBus</strong><br />
					<br /> <strong>대표</strong>&nbsp; 류종학<br /> <strong>정보보호
						담당자</strong>&nbsp;김도유<br /> <strong>주소</strong>&nbsp;서울시 성동구 무학로2길 54 신방빌딩
				...
				<td align="left">문의<br /> <br /> &nbsp;&nbsp;<strong>전화</strong>
					...
					</form> <br /> <a href="#"><img src="../resources/images/kakao.png" width="35"
						height="35"></a> <a href="#"><img
						src="../resources/images/facebook.png" width="35" height="35"></a> <a
					href="#"><img src="../resources/images/insta.png" width="35" height="35"></a>
		</table>
	</footer>
