...
<body>
	...
	<div id="id" class="tabcontent">
		<form id="signupform" role="form" action="sendFindId.do" method="post">
			<h3>아이디찾기</h3>
			<table>
				...
				<tr>
					...
					<td align="left" width="500"><input type="text" name="name"
						value="${memberVO.name}" placeholder="이름을 작성해주세요."
						autocomplete="off"></td>
				</tr>
				...
				<tr>
					...
					<td align="left"><input type="text" name="email"
						value="${memberVO.email}" placeholder="이메일을 작성해주세요"
						autocomplete="off"></td>
				</tr>
				<tr>
					<td><div style="color: red; margin-top: 2px">
