...
<body>
	...
	<div>
		...
		<div align="center">
			...
			<table id="tb01">
				<tr>
					<td><i class='far fa-address-card'
						style='font-size: 100px; color: rgb(49, 100, 176)'></i></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td><font size="5"><span style="color: red"><b>결제</b></span>가
							<b>완료</b>되었습니다.</font><br /> <b>"${vo.name }" </b>님의 결제가 정상적으로 처리되었습니다.
						<br />아래 결제내역을 확인해 주세요.</td>
				</tr>
		...
		<table align="center" width="700">
			<tr>
				<td align="left"><i class='fas fa-arrow-alt-circle-right'
					style='font-size: 20px'></i>&nbsp;결제완료내역</td>
				<td></td>
			</tr>
		</table>
		...
		<table id="tb02" align="center">
			...
			<tr>
			<tr class="bottom">
				<td class="color">좌석번호</td>
				<td>&nbsp;${vo.sitnum }번</td>
			</tr>
			<tr class="bottom">
				<td class="color">결제금액</td>
				<td>&nbsp;${vo.pay }</td>
			</tr>
			<tr class="bottom">
				<td class="color">결제일시</td>
				<td>&nbsp;<%=year%>년 <%=month + 1%>월 <%=day%>일 <%=hour%>시 <%=minute%>분<%=second%>초
				</td>
			</tr>
			<tr class="bottom">
				<td class="color">결제수단</td>
				<td>&nbsp;${vo.selectpay }</td>
			</tr>
...
예약테이블
 -->
		<br>
		<!-- 뿌려주기 -->
		<input type="button" value="영수증출력" onClick="fnPrint()" /> <a
			href="main.do"><input type="button" value="메인페이지로 이동"></a> <a
			href="getBookBoardList.do"><input type="button"
			value="배차조회목록으로 이동"></a>
	</div>
	<br />
	...
	<script type="text/javascript">
		var fnPrint = function() {
			...
			objWin.document.write("<td>");
			objWin.document.write("&nbsp;");
			objWin.document.write("${vo.pay } &nbsp; (실제 결제금액 + 포인트사용금액)");
			objWin.document.write("</td>");
			objWin.document.write("</tr>");
			objWin.document.write("<tr class='bottom'>");
			objWin.document.write("<td class='color'>");
