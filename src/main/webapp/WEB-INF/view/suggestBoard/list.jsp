...
<body>
	...
	<div align="center">
		...
		<table border="1" width="700" cellpadding="0" cellspacing="0"
			...
			<c:forEach var="vo" items="${list }">
				<tr height="30">
					...
					<td width="250"><a href="getSuggestBoard.do?seq=${vo.seq}">${vo.title }</a></td>
		...
		<table width="700">
			<tr>
				<td align="right">
					<form name="form" action="writeSuggestBoard.do" method="POST">
		...
		<table>
			<tr>
				...
				<td><a href="dataTransform.do">지도 데이터 변환</a><a href="cluster.do">클러스터통계</a></td>
		</table>
