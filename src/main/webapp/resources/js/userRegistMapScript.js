...
function search() {
	...
	daum.maps.event.addListener(map, 'click', function(mouseEvent) {
		...
		var resultStartWido = document.getElementById('spanImsiWido');
		var resultStartKyungdo = document.getElementById('spanImsiKyungdo');
		resultStartWido.innerHTML = imsi_wido;
		resultStartKyungdo.innerHTML = imsi_kyungdo;
		var imsi1 = document.writeForm.imsi_wido.value = imsi_wido;
		var imsi2 = document.writeForm.imsi_kyungdo.value = imsi_kyungdo;

		//alert(document.writeForm.imsi_wido.value);
		//alert(document.writeForm.imsi_kyungdo.value);
