...
public class SuggestBoardVO {
	...
	public String toString() {
		return "SuggestBoardVO [seq=" + seq + ", id=" + id + ", name=" + name + ", title=" + title + ", content="
				+ content + ", best=" + best + ", regDate=" + regDate + ", cnt=" + cnt + ", cntPerPage=" + cntPerPage
				...
				+ ", pay=" + pay + ", finishtime=" + finishtime + ", realstartdate=" + realstartdate + ", bestcount="
				+ bestcount + ", c_startdate=" + c_startdate + ", c_enddate=" + c_enddate + "]";
	}
